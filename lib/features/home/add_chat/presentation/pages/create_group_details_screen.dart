...
class _CreateGroupDetailsScreenState extends State<CreateGroupDetailsScreen> {
  ...
  String get currentUserId => '567450057'; // استبدل بـ FirebaseAuth لاحقاً
  ...
  Future<void> _takePhoto() async {
    try {
      ...
      Get.snackbar('خطأ', 'فشل التقاط الصورة: $e',
          backgroundColor: Colors.red, colorText: Colors.white);
    }
  }
  ...
  Future<void> _uploadImageToCloudinary(File file) async {
    ...
    try {
      ...
      Get.snackbar('تم الرفع', 'تم رفع صورة المجموعة بنجاح',
  ...
  Widget _buildNameField() => _buildTextField(
      _nameController, 'اسم المجموعة', true, Icons.group, 'مثال: مجموعة الأصدقاء');

  Widget _buildDescriptionField() => _buildTextField(
      _descriptionController, 'وصف المجموعة (اختياري)', false, Icons.description,
      'أضف وصفاً للمجموعة...');
  ...
  Future<void> _createGroup() async {
    ...
    if (_isUploadingImage) {
      Get.snackbar('تنبيه', 'الرجاء انتظار رفع الصورة أولاً',
    ...
    try {
      ...
      Get.snackbar('نجح', 'تم إنشاء المجموعة بنجاح',
