    ...
    return Center(
      child: Column(
        children: [
          ...
          Text(
            _selectedImage != null ? 'تغيير صورة المجموعة' : 'إضافة صورة المجموعة',
            style: getRegularTextStyle(
      ...
      if (_selectedImage != null) {
        try {
          imageUrl = await CloudinaryService.upload(
            file: _selectedImage!,
            type: 'image',
            folder: 'chat_media/groups',
          );
          print('✅ تم رفع الصورة إلى Cloudinary: $imageUrl');
        } catch (e) {
          print('❌ خطأ في رفع الصورة: $e');
          Get.snackbar(
            'تنبيه',
            'تم إنشاء المجموعة بدون صورة بسبب خطأ في الرفع',
            snackPosition: SnackPosition.BOTTOM,
