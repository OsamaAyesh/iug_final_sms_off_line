// المسار: lib/core/storage/local/app_settings_prefs.dart
...
class AppSettingsPrefs {
  ...
  String? getUserImage() {
    return _sharedPreferences.getString(SharedPrefsConstants.userImage).onNull();
  }
  ...
  String? getUserEmail() {
    return _sharedPreferences.getString(SharedPrefsConstants.userEmail).onNull();
  }

  /// التحقق من وجود بيانات مستخدم مسجل
  bool hasUserData() {
    return getUserId().isNotEmpty && getUserLoggedIn().onNull();
  }
